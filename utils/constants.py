...
patterns = {
    ...
    r'(\d{6})[-_]+(\d{3})': r'\1-\2',
    r'(?<![\w])([nNkK]\d{4})': r'\1',
    r"([a-z]{2,6})[-_]?(\d{2,3})[-_](\d{1,2})(?!(k))": lambda m: f"{m.group(1)}-{m.group(2).zfill(3)}_{m.group(3).zfill(2).upper()}",
    ...
    r"([a-z]{2,5})-(\d{2,3})[\s]+([A-Ea-e])(?![a-zA-Z])": lambda m: f"{m.group(1)}-{m.group(2).zfill(3)}_{m.group(3).upper()}",
    ...
    r"([a-z]{4,6})(\d{3,5})": lambda m: f"{m.group(1)}-{m.group(2).zfill(3)}",
    r'([A-Z][A-Z0-9]{6})[-_/s](?!\d{6,9})(\d{2,5})': r'\1-\2',
    r'([A-Z]{2,7})[-_](?!\d{6,9})(\d{2,5})': r'\1-\2',
    r'([A-Z]{2,7})[-_]?(?!\d{6,9})(\d{2,5})': r'\1-\2',
    r'([A-Z][A-Z0-9]{3,8})[-_]*(?!\d{6,9})(\d{3,5})': r'\1-\2',
    r'([a-zA-Z]{4,6})[-_\s]?(\d{3,5})': r'\1-\2',
    r'(?i)([A-Z][a-zA-Z0-9]{2,8})[-_0](\d{2,5})': r'\1-\2',
    r'([a-zA-Z]{3,4})(\d{2,5})': r'\1-\2',
    r'([a-zA-Z]{2,4})[-_]?(\d{2,5})': r'\1-\2',
    r'([a-zA-Z]{2,4})[-_]?(\w?[\d]{2,5})': r'\1-\2',
}